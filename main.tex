...
\section{Projects}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Led development of an NFT marketplace allowing users to create, buy, and sell digital art on the blockchain, resulting in a 40\% increase in monthly transactions.}
            \resumeItem{Utilized React and Tailwind CSS to optimize frontend performance, resulting in a 30\% decrease in loading times.}
            \resumeItem{Implemented secure smart contracts using Solidity and integrated Metamask for wallet transactions, ensuring smooth and secure transactions for users.}
            \resumeItem{Deployed and tested the application on Polygon, reducing transaction fees by 25\% and enhancing user experience.}
          ...
          \resumeItemListStart
            \resumeItem{Developed MovieMoods, a user-friendly web app allowing users to explore movies based on mood and preferences, resulting in a 50\% increase in user engagement.}
            \resumeItem{Integrated TMDB API for real-time movie data, enhancing the app's accuracy and reliability.}
            \resumeItem{Implemented advanced features such as mood-based filtering and voice recognition using React, Redux, and Material UI, providing users with a seamless browsing experience.}
            \resumeItem{Designed a responsive and intuitive interface adaptable across various devices, resulting in positive feedback from users.}
          ...
          \resumeItemListStart
            \resumeItem{Led the development of an intelligent AI chatbot capable of diagnosing diseases and providing personalized recommendations, achieving a 95\% accuracy rate in diagnosis.}
            ...
            \resumeItem{Deployed the chatbot on Telegram and conducted extensive user testing, resulting in positive user feedback and high user satisfaction.}
            \resumeItem{Enabled chatbot to suggest medications, exercises, and dietary plans based on diagnosis, providing users with personalized health advice.}
